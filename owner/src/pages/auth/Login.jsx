      ...
      >
        <div className="bg-white rounded-card shadow-card-md px-10 py-10">
          ...
          >
            ...
            <h1 className="text-2xl font-extrabold text-brown-dark tracking-tight">Welcome back</h1>
            <p className="text-sm font-semibold text-brown-muted mt-1">Login to your owner account</p>
          </motion.div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">

            <motion.div className="space-y-1.5" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.22, duration: 0.45 }}>
            ...
            <motion.div className="space-y-1.5" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.45 }}>
            ...
            <motion.div className="flex justify-end -mt-1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.36 }}>
              <span
                className="text-xs font-bold text-brown-mid hover:text-brown-dark cursor-pointer transition-colors duration-150"
            ...
            <motion.div className="space-y-3 pt-1" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
              <Button
                type="submit"
            ...
            <motion.p className="text-sm text-center text-brown-muted font-semibold pt-1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.48 }}>
              Don't have an account?{" "}
              <span className="text-brown-dark font-bold hover:underline cursor-pointer" onClick={() => navigate("/register")}>
                Register
              </span>
            </motion.p>
